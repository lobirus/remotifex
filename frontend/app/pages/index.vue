    ...
    <div class="max-w-6xl mx-auto px-6 py-8">
      ...
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">Manage your AI-powered development projects</p>
        </div>
      ...
      >
        <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-brand-50 mb-6">
        ...
        <h2 class="text-lg font-semibold text-gray-900 mb-2">No projects yet</h2>
      ...
      >
        ...
        >
          <div class="flex items-start justify-between mb-3">
            <h3 class="text-base font-semibold text-gray-900 group-hover:text-brand-600 transition-colors">
              {{ project.name }}
            </h3>
            <span
      ...
      >
        ...
        >
          ...
          <div class="relative w-full max-w-md card p-6 animate-slide-up">
            <h2 class="text-lg font-semibold text-gray-900 mb-1">New Project</h2>
            ...
            <form @submit.prevent="handleCreate" class="space-y-4">
              ...
              <div>
                <label for="project-description" class="block text-sm font-medium text-gray-700 mb-1.5">
                  Description
